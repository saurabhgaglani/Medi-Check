...
public class RegisterActivity extends AppCompatActivity {
    Button btn2_signup,cancel_action;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user_name=findViewById(R.id.EmailAddress);
        pass_word=findViewById(R.id.CreatePassword);
        btn2_signup=findViewById(R.id.RegisterUser);
